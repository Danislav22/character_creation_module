...
def attack(char_name: str, char_class: str) -> str:
    """It's a code for move 'Attack'. It has a random value."""
    ...
    return 'а что ты не то ввел а?'


def defence(char_name: str, char_class: str) -> str:
    """It's a code for move 'Defence'."""
    if char_class == 'warrior':
    ...
    return 'введи на английском, если не знаешь англ вот тебе буквы abcdefg'


def special(char_name: str, char_class: str) -> str:
    """It's a code for move 'Special'."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Player uses his abilities to attack/defence or use special ability in a battle."""
    if char_class == 'warrior':
