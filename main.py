...
def attack(char_name: str, char_class: str) -> str:
    """Действие атаки, в зависимости от.
    класса наносим разный урон противнику.
    """
...
def defence(char_name: str, char_class: str) -> str:
    """Блокировка удара, уменьшаем получаемый урон."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """
    Пользователь вводит класс.
    персонажа и подтверждает его.
    """
    approve_choice: str = ''
    char_class: str = ''
